...
public class TeamInfo {
	...
	public String getAlcoholNm() {
		return alcoholNm;
	}
	public void setAlcoholNm(String alcoholNm) {
		this.alcoholNm = alcoholNm;
	}
	...
	public String getTeamImgCd() {
		return teamImgCd;
	}
	public void setTeamImgCd(String teamImgCd) {
		this.teamImgCd = teamImgCd;
	}
